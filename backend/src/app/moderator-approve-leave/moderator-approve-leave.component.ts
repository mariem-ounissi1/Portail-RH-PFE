...
@Component({
  selector: 'app-moderator-approve-leave',
  templateUrl: './moderator-approve-leave.component.html',
  styleUrls: ['./moderator-approve-leave.component.css']
})
export class ModeratorApproveLeaveComponent implements OnInit {
  dtOptions: any;
 ...
 constructor(private storageService: StorageService, private moderatorLeaveService: ModeratorLeaveService ,private userService: UserService ) {}
...
// } else if (action === 'reject') {
 ...
 approveLeave(applicationId: number): void {
   this.moderatorLeaveService.approveLeave(applicationId)
     .subscribe(
       (response) => {
 ...
 rejectLeave(applicationId: number): void {
   this.moderatorLeaveService.rejectLeave(applicationId)
     .subscribe(
       (response) => {
